package com.backend.EJ31_CRUD.content.person.application;
...
import com.backend.EJ31_CRUD.content.person.infraestructure.repository.services.PersonRepositoryService;
...
public class PersonServiceImp implements PersonService {
    ...
    public void createPerson(Person person) throws UnprocesableException {
        if (person == null) throw new UnprocesableException("No es posible insertar una persona como nula");
    ...
    @Override
    public Optional<Person> findById(Long id) throws NotFoundException, IllegalStateException {
    ...
    @Override
    public Person updatePerson(Long id, PersonInputDTO personInput) throws NotFoundException {
    ...
    public void deleteById(Long id) throws Exception {
        if (personRepositoryService.findById(id).get().getTeacher() != null) throw new Exception();
